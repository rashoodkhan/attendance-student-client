...
namespace attendance
{
    ...
    public class AttendanceRecord
    {
        ...
        [JsonProperty(PropertyName = "attend_count")]
    ...
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        private MobileServiceCollection<AttendanceRecord,AttendanceRecord> attendance;

        private IMobileServiceTable<AttendanceRecord> attendanceTable = App.MobileService.GetTable<AttendanceRecord>();
